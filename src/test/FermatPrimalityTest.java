...
import org.junit.*;
import main.java.FermatPrimality;
...
public class FermatPrimalityTest {
    ...
    public void primeTesting(){
        ...
        Assert.assertEquals(FermatPrimality.isPrime(largePrime, 45), true);

        BigInteger largePrime2 = BigInteger.probablePrime(1024, new Random());
        Assert.assertEquals(FermatPrimality.isPrime(largePrime2, 45), true);
    }
    ...
    public void compositeTesting(){
        ...
        Assert.assertEquals(FermatPrimality.isPrime(largeComposite, 45), false);

        BigInteger largeComposite2 = (BigInteger.probablePrime(1024, new Random()).multiply(BigInteger.probablePrime(1024, new Random())));
        Assert.assertEquals(FermatPrimality.isPrime(largeComposite2, 45), false);
